...
if __name__ == '__main__':
    # print(check_csrf_get('http://192.168.103.53:8765/pikachu/vul/csrf/csrfget/csrf_get_login.php'))
    # print(check_csrf_post('http://192.168.103.53:8765/pikachu/vul/csrf/csrfpost/csrf_post_login.php'))
    # print(check_csrf_token('http://192.168.103.53:8765/pikachu/vul/csrf/csrftoken/token_get_login.php'))
    print(check_csrf_vulnerabilities('http://192.168.103.53:8765/pikachu/vul/csrf/csrfget/csrf_get_login.php'))