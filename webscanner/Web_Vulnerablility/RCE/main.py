from Web_Vulnerablility.RCE.RemoteCommandExecutation import check_rce_vulnerability_command
from Web_Vulnerablility.RCE.RemoteCodeExecute import check_rce_vulnerability_code
